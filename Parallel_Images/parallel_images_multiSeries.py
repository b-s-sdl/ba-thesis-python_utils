...
def get_annotate_info(ds, basedir):
    ...
    current_rel_m13 = hst_data[index_hst,11]/hst_data[0,11]
    current_rel_vwind = hst_data[index_hst,28]/hst_data[0,28]
...
def run_parallels(basedir:dir, field_list, periodicity:bool):
    ...
    for i in ts.piter():
        ...
        for field in field_list:
            ...
            elif field[1] == "cloud_temperature":
            ...
            title =  f"$\chi = 100$, $t= {current_tcc:.2f} t_{{\mathrm{{cc}}}}$, $m_{{1/3}} = {current_rel_m13:.2f} m_{{\mathrm{{cl}}}}, m_{{\mathrm{{wind,rel}}}}= {current_rel_vwind:.2f} v_{{\mathrm{{wind,init}}}}$"
...
if __name__ == "__main__":
    ...
    field_list = [('athena', 'cloud_temperature',),('gas','density'),('athena','specific_scalar[0]'),('gas','velocity_x'),('gas','pressure')]
    ...
    run_parallels(args.basedir, field_list, args.periodicity)